...
// ======================================================================== // 
    ...
    function bootstrap_shortcodes_styles_all() {
        wp_register_style( 'bootstrap-shortcodes-help-all', plugins_url( 'includes/help/css/bootstrap-shortcodes-help-all.css', dirname(__FILE__) ) );
...
// ======================================================================== // 
    ...
    function bootstrap_shortcodes_help_styles() {
        wp_register_style( 'bs-font', plugins_url( 'includes/help/bs-font.css', dirname(__FILE__) ) );
        wp_register_style( 'bootstrap-shortcodes-help', plugins_url( 'includes/help/css/bootstrap-shortcodes-help.css', dirname(__FILE__) ) );
        wp_register_style( 'bootstrap-modal', plugins_url( 'includes/help/css/bootstrap-modal.css', dirname(__FILE__) ) );
        wp_register_script( 'bootstrap', plugins_url( 'includes/help/js/bootstrap.min.js' , dirname(__FILE__) ) );
